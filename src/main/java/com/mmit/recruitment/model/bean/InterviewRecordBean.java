...
import com.mmit.recruitment.model.service.InterviewRecordService;
...
public class InterviewRecordBean implements Serializable{
	...
	public void insertInterviewRecord(JobPipeline edit_jobpipeline) {
		...
		if(eidtInterviewRecord.isEmpty() ) {
			...
			interviewRecord.setStatus(jobpipelineBean.getJobpipeline().getCandidatejoborderstatus());
			...
			existingInterviewRecord.setStatus(jobpipelineBean.getJobpipeline().getCandidatejoborderstatus());
